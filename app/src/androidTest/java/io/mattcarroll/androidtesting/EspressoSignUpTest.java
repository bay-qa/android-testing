...
public class EspressoSignUpTest {
    ...
    public void userSignUpVerifyBackButtonWorksOnEachPage() {
        ...
        scrollToAndFill(R.id.edittext_first_name, "TestName");
        scrollToAndFill(R.id.edittext_last_name, "TestLastName");
        scrollToAndFill(R.id.edittext_address_line_1, "TestAddress");
        scrollToAndFill(R.id.edittext_address_city, "TestCity");
        scrollToAndFill(R.id.edittext_address_state, "TestState");
        scrollToAndFill(R.id.edittext_address_zip, "12345");
        scrollToAndTapNext();
        // select interest
