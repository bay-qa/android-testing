...
public class EspressoSignInTest {
    ...
    @Test
    public void userSignInVerifyNoLinkedAccountSlipIsDisplayed() {

        onView(withId(R.id.edittext_email)).perform(typeText("test@gmail.com"));
        onView(withId(R.id.edittext_password)).perform(typeText("Password123$"));
